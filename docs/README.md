...
| [color-management.md](specifications/color-management.md) | 作業空間・入力/表示/出力の変換点・量子化の規則 |
...
| [ui/](specifications/ui/) | ビューごとの仕様（viewer / timeline / node-editor / outliner / properties / media-bin / render-queue / theme / keybindings / settings / workspaces） |
