...
| `media-import-plan.md` | Media import, asset references, MediaBin, and the unified media node | In progress — units 1, 2, 5 done — 2026-07-26 | REQ-UI-008, REQ-UI-010, REQ-PROJ-001 |
