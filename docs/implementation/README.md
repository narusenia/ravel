...
| `viewer-tool-extensions-plan.md` | Hand/Zoom tools, box selection, path point editing, polygon/star drawing — takes over MED-APP-15 | TOOLX-1 done — 2026-08-28; TOOLX-2 / TOOLX-3 done — 2026-09-02 | REQ-UI-011 |
