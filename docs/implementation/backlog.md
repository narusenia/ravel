...
| ID | 状態 | 単位 | 依存 |
|---|---|---|---|
| A4-1 | ✅ | 出力レート音声のアセットキャッシュ | this PR |
| A4-2 | ✅ | Composition 終端の Pause 公開 | this PR |
| A4-3 | ✅ | 音声準備状態と失敗の可視化 | this PR |
| A4-4 | ✅ | 文書更新と完了ゲート | this PR |
...
| A3-6 | ✅ | 文書と完了ゲート | #207 |
| A4-1〜4 | ✅ | 出力レート準備キャッシュ / 終端 Pause / 状態と失敗の可視化 | this PR |
