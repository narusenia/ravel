...
| GPUBK-14 | ⬜ | wgpu 直叩きの取り分を測る（GPUBK-10〜12 の判断ゲート） | GPUBK-4, MED-GPU-07 |
| GPUBK-10 | ❓ | Metal バックエンド（GPUBK-14 の判定待ち） | GPUBK-14 |
| GPUBK-11 | ❓ | D3D12 バックエンド（GPUBK-14 の判定待ち） | GPUBK-10 |
| GPUBK-12 | ❓ | Vulkan バックエンド（GPUBK-14 の判定待ち） | GPUBK-10 |
