...
|----|----------|------|--------|------|-----------|
| MS1 | Foundation | コアエンジン基盤、GPUIシェル、プロジェクトファイル | 8 | 0/8 | Not Started |
...
|--------|---------|------|------|-----------|
| TASK-001 | 型システム + ノードグラフデータモデル | L | - | 🔲 Not Started |
| TASK-002 | DAG評価エンジン | L | 001 | 🔲 Not Started |
| TASK-003 | スレッディングモデル + CI基盤 | M | 001 | 🔲 Not Started |
| TASK-004 | アンドゥシステム | M | 001 | 🔲 Not Started |
| TASK-005 | wgpu GPU計算パイプライン基盤 | L | 003 | 🔲 Not Started |
| TASK-006 | GPUIアプリケーションシェル | L | 005 | 🔲 Not Started |
| TASK-007 | アニメーションチャネルシステム | M | 001,002 | 🔲 Not Started |
| TASK-008 | プロジェクトファイル (.ravprj) | M | 001,004 | 🔲 Not Started |
