...
| MS6 | Pro Features | OCIO、OpenFX、Lua、カスタムシェーダ、コードLayer | 8 | 0/8 | Not Started |
...
| TASK-048 | コード Layer / コードノード基盤 | L | 032,038,040 | 🔲 Not Started |
| TASK-049 | シーケンス糖衣 API（timeline ビルダ） | M | 048 | 🔲 Not Started |
| TASK-050 | コードホットリロード | M | 048 | 🔲 Not Started |
...
| REQ-CODE-001 | TASK-048 |
| REQ-CODE-002 | TASK-049 |
| REQ-CODE-003 | TASK-050 |
| REQ-CODE-004 | （Could — REQ-PLUGIN-002 WASM 基盤後に計画） |
