...
## 完了条件
- [ ] FFmpegがダイナミックリンクで正しくリンクされLGPL準拠
- [ ] `MediaReader`トレイトで主要コーデック（H.264, H.265, AV1, ProRes, DNxHR）のデコードが動作
- [ ] `MediaWriter`トレイトでエンコードパイプラインが動作
- [ ] MP4, MOV, MKV, WebMコンテナの読み書き対応
- [ ] EXR, PNG, TIFF, DPXイメージシーケンスの読み込み対応
- [ ] フォーマット自動検出が正しく機能
- [ ] サンプルメディアを用いた結合テストがパス
